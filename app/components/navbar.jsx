    ...
    <nav className="bg-transparent">
      <div className="flex items-center justify-between py-5">
        <div className="flex flex-shrink-0 items-center">
          <Link
            href="/"
            className=" text-indigo-400 text-3xl font-bold tracking-wide">
           AN-JONG DEGBEY
          </Link>
        </div>
        ...
        <ul className="mt-4 flex h-screen max-h-0 w-full flex-col items-start text-sm opacity-0 md:mt-0 md:h-auto md:max-h-screen md:w-auto md:flex-row md:space-x-1 md:border-0 md:opacity-100" id="navbar-default">
         ...
         <Link href="/#blogs">
  <div className="block px-4 py-2 no-underline outline-none hover:no-underline">REALISATIONS</div>
</Link>
           <li>
            <Link className="block px-4 py-2 no-underline outline-none hover:no-underline" href="/#education"><div className="text-sm text-white transition-colors duration-300 hover:text-pink-600">HOBBIES</div></Link>
          </li>
           <li>
